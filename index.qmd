...
::: {.column width="50%"}
![Format guiltlessly stolen from the Amaerican neuropsychology podcast NevNeuro.](images/nav-neuro.jpeg)
:::
:::
...
-   **Medication:** anti-hypertensive, anti-depressent.
...
-   Masked at times by using alternative words and looking to wife.
...
::: columns
::: {.column width="50%"}
![Key diagnostic crtieria for PPA. Taken from Gorno-Tempini et al (2011).](images/table%201.jpg){alt="Key diagnostic crtieria for PPA. Taken from Gorno-Tempini et al (2011)." width="1000"}
:::
...
![Key diagnostic crtieria for lvPPA. Taken from Gorno-Tempini et al (2011).](images/table-logo.jpg)
